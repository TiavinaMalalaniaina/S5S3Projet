 ...
 * @author tiavi
 */
@WebServlet(name = "StatVenteServlet", urlPatterns = {"/StatVente"})
public class StatVenteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            int meubleId = 0;
            String meubleIdStr = request.getParameter("meubleId");
            ...
            request.setAttribute("viewTitle", "Statistique de vente");
