 ...
 * @author tiavi
 */
@WebServlet(name = "FormVenteServlet", urlPatterns = {"/FormVente"})
public class FormVenteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            model.clients = Client.findAll(null);
            model.setError(request.getParameter("error"));
            request.setAttribute("viewName", "components/formVente.jsp");
            request.setAttribute("title", "VENTE");
            request.setAttribute("viewTitle", "Ajout de vente");
